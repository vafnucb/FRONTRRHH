  ...
  export default {
    ...
    methods: {
      ...
      generatePDF () {
        ...
        doc.setFontSize(18)
        doc.text('Información Sobre Actividades Académicas Postgrado', 145, 35, null, null, 'center')
      ...
      loadCareerBody () {
        ...
        console.log('/BusquedaAvanzadaIsaacPost/' + this.url)
        axios.get('/BusquedaAvanzadaIsaacPost/' + this.url)
          .then(response => {
