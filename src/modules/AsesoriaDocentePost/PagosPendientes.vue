...
export default {
  data() {
    return {
      ...
      fechaFin: '',
      branchesId: null,
      dateError: false, // Added for date validation
      regions: [
        { id: 2, abr: 'TJA' },
        { id: 3, abr: 'CBB' },
        { id: 16, abr: 'SCZ' },
  ...
  computed: {
    ...
    selectedFilters() {
      ...
      if (this.fechaInicio) {
        filters.push({ 
          label: 'Fecha Inicio', 
          value: this.formatDate(this.fechaInicio) 
        });
      }
      ...
      if (this.fechaFin) {
        filters.push({ 
          label: 'Fecha Fin', 
          value: this.formatDate(this.fechaFin) 
        });
      }
  ...
  methods: {
    ...
    resetFilters() {
      ...
      this.dateError = false; // Reset error state
    },
